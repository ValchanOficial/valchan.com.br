...
console.log(final[0]); // Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec quis turpis eget
console.log(final[24]); //  porttitor dignissim nibh venenatis, blandit hendrerit odio. 123459696966969
```
